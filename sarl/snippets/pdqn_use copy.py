...
def _get_training_info(train_episodes, agent, env, max_steps, seed, pad_action, reward_scale=1, output_dir=None, eval_env=None, eval_episodes=None):
    ...
    # for episode_index in tqdm(range(train_episodes)):
        ...
        if output_dir is not None:
            output_dir = "/Users/tm0/github/SARL/sarl/outputs/2025-09-24-one-pdqn-goal"
...
pdqn_goal(train_episodes=1000000, max_steps=500, seeds=[1], output_dir=True, learning_steps=None, cycles=None, eval_episodes=25)
