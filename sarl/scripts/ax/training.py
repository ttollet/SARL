"""
Core training functions shared by grid search and Bayesian optimization.

Functions:
    build_config: Build Hydra config for training
    run_training: Execute training and return mean reward
"""
