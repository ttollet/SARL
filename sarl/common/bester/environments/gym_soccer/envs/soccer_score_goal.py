...
class SoccerScoreGoalEnv(SoccerEmptyGoalEnv):
    ...
    def __init__(self):
        ...
        # meant to be 0, not -100! (according to original soccer env and dqn-hfo inverting gradients)
        ...
        self.action_space = spaces.Tuple((spaces.Discrete(3),
                                          spaces.Box(
                                              low=low0, high=high0, dtype=np.float32),
                                          spaces.Box(
                                              low=low1, high=high1, dtype=np.float32),
